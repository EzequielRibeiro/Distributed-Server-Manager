...
class AgentDashboardUiContractTest(unittest.TestCase):
 ...
 def test_dashboard_v3_navigation_preserves_rbac_and_add_agent(self):
  for text in ('href="servers.html"','href="agents.html"','href="add-agent.html"','admin-only','agent-manager-only','href="catalog.html"','href="game-profiles.html"','href="observability.html"','href="alerts.html"','href="events.html"','href="monitoring.html"','href="controller-logs.html"','href="diagnostics.html"','href="operations.html#backups"'):self.assertIn(text,self.sidebar)
  for legacy in ('observability.html#alerts','observability.html#events','observability.html#monitoring','observability.html#diagnostics'):self.assertNotIn(legacy,self.sidebar)
