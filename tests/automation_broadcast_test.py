...
class D1RepositoryTest(unittest.TestCase):
 def setUp(self):
  ...
  with self.backend.transaction() as c:
   c.execute("INSERT INTO nodes(id,name,role) VALUES (?,?,?)",("controller-node","Controller","controller"));c.execute("INSERT INTO nodes(id,name,role) VALUES (?,?,?)",("agent-node","Agent","agent"));c.execute("INSERT INTO controllers(id,node_id,name) VALUES (?,?,?)",("controller-d1","controller-node","D1"));c.execute("INSERT INTO agents(id,controller_id,node_id,name,status) VALUES (?,?,?,?,?)",("agent-d1","controller-d1","agent-node","Agent D1","active"));c.execute("INSERT INTO customers(id,controller_id,name,status) VALUES (?,?,?,?)",("customer-d1","controller-d1","Customer","active"));c.execute("INSERT INTO instances(id,node_id,game_id,name,status,controller_id,agent_id,customer_id) VALUES (?,?,?,?,?,?,?,?)",("instance-d1","agent-node","game.generic","Generic","offline","controller-d1","agent-d1","customer-d1"))
