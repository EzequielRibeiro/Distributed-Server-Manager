...
class CreateServerWizardContractTest(unittest.TestCase):
 ...
 def test_phase7_assets_are_loaded(self):self.assertIn('/create-server-wizard.css?v=',self.html);self.assertIn('/create-server-wizard.js?v=',self.html);self.assertIn('id="runtime-placement-status"',self.html)
