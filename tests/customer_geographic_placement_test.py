...
class CustomerGeographicPlacementTest(unittest.TestCase):
    def test_customer_receives_only_public_logical_locations(self):
        ...
        for secret in (
            "secret-agent-sp", "secret-agent-us", "secret-node-sp", "secret-node-us",
            "10.0.0.10", "10.0.0.20", "secret-fingerprint", "secret-dc-sp", "secret-dc-us",
        ):
    ...
    def test_unavailable_region_is_not_recommended(self):
        ...
        self.assertEqual(by_region["br-sudeste"]["recommendation"], "server_recommended")
