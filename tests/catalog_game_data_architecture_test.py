...
class CatalogGameDataArchitectureTest(unittest.TestCase):
    ...
    def test_game_profiles_have_a_dedicated_navigation_area(self):
        ...
        self.assertIn('id="catalog-resource-default"', catalog)
        self.assertIn('id="catalog-resource-apply-default"', catalog)
        self.assertIn("applyCatalogDefaultProfile", (ROOT / "dashboard/web/catalog-page.js").read_text(encoding="utf-8"))
