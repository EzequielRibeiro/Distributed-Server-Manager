...
CREATE TABLE IF NOT EXISTS federation_credentials (
    ...
    token_prefix VARCHAR(191) NOT NULL UNIQUE,
    ...
    CONSTRAINT fk_federation_credentials_controller FOREIGN KEY(controller_id) REFERENCES federation_controllers(controller_id) ON DELETE CASCADE
);
CREATE INDEX idx_federation_credentials_controller ON federation_credentials(controller_id, status);
...
CREATE TABLE IF NOT EXISTS federation_request_nonces (
    ...
    CONSTRAINT fk_federation_nonce_controller FOREIGN KEY(controller_id) REFERENCES federation_controllers(controller_id) ON DELETE CASCADE
);
CREATE INDEX idx_federation_request_nonces_received ON federation_request_nonces(received_at);
...
CREATE TABLE IF NOT EXISTS federation_snapshots (
    ...
    CONSTRAINT fk_federation_snapshot_controller FOREIGN KEY(controller_id) REFERENCES federation_controllers(controller_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS federation_routes (
    ...
    CONSTRAINT fk_federation_route_controller FOREIGN KEY(controller_id) REFERENCES federation_controllers(controller_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS federation_event_cursors (
    ...
    updated_at VARCHAR(64) NOT NULL,
    CONSTRAINT fk_federation_cursor_controller FOREIGN KEY(controller_id) REFERENCES federation_controllers(controller_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS federation_event_receipts (
    ...
    CONSTRAINT fk_federation_receipt_controller FOREIGN KEY(controller_id) REFERENCES federation_controllers(controller_id) ON DELETE CASCADE
);
CREATE INDEX idx_federation_event_receipts_time ON federation_event_receipts(received_at);
...
CREATE TABLE IF NOT EXISTS federation_handoffs (
    ...
    created_at VARCHAR(64) NOT NULL,
    updated_at VARCHAR(64) NOT NULL,
    CONSTRAINT fk_federation_handoff_controller FOREIGN KEY(target_controller_id) REFERENCES federation_controllers(controller_id) ON DELETE RESTRICT
);
CREATE INDEX idx_federation_handoffs_target_status ON federation_handoffs(target_controller_id, status, created_at);
