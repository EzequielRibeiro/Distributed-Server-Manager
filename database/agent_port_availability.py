...
def effective_port_summary(
    ...
    *,
    ...
    # not connectivity. Expose the heartbeat projection and network snapshot
    # separately so callers can reason about actual allocation readiness.
