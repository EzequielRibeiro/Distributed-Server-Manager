...
CREATE TABLE IF NOT EXISTS backup_jobs (
 command_id VARCHAR(191) PRIMARY KEY, backup_id VARCHAR(191), instance_id VARCHAR(191) NOT NULL, agent_id VARCHAR(191) NOT NULL,
 ...
 INDEX idx_backup_jobs_backup_id(backup_id), INDEX idx_backup_jobs_agent_status(agent_id,status,created_at), INDEX idx_backup_jobs_instance_completed(instance_id,completed_at)
);
