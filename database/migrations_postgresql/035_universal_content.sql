-- Capivara DSM - Migration 035 - PostgreSQL
CREATE TABLE content_assignments (
 ...
 revision BIGINT NOT NULL, checksum TEXT NOT NULL, requested_by TEXT, created_at TEXT NOT NULL, updated_at TEXT NOT NULL,
 UNIQUE(instance_id,content_id)
);
CREATE TABLE content_assignment_revisions (
 assignment_id TEXT NOT NULL, revision BIGINT NOT NULL, desired_state TEXT NOT NULL,
...
CREATE TABLE agent_content_state (
 ...
 desired_revision BIGINT NOT NULL, applied_revision BIGINT, desired_checksum TEXT NOT NULL, applied_checksum TEXT,
