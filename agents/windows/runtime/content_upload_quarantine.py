...
def quarantine_destination(instance_id,transfer_id,filename):
 candidate=(QUARANTINE_ROOT/_token(instance_id)/_token(transfer_id)/_filename(filename)).resolve();candidate.relative_to(QUARANTINE_ROOT);return candidate
