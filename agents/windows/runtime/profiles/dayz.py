...
class DayZRuntimeProfile(GameRuntimeProfile):
 ...
 def build_runtime_spec(self,instance:dict[str,Any],context:dict[str,Any])->dict[str,Any]:
  ...
  game_port=require_port(context,"game",protocol="udp");game_aux_port=require_port(context,"game_aux",protocol="udp");battleye_port=require_port(context,"battleye",protocol="udp");steam_query_port=require_port(context,"steam_query",protocol="udp")
