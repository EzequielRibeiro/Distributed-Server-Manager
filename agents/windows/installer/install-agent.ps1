...
$required = @(
    ...
    "agent\runtime\agent.py", "agent\runtime\agent_entrypoint.py", "agent\runtime\console_stream_client.py", "agent\runtime\uninstall_client.py", "agent\runtime\capabilities.py", "agent\runtime\network_inventory.py", "agent\runtime\update_client.py", "agent\runtime\admin_gui_backend.py",
