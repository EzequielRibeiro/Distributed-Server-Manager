...
def _validate_python(package_root: Path) -> None:
    ...
    files = [
        ...
        runtime / "runtime_events.py", runtime / "runtime_materialization.py", runtime / "runtime_reconciler.py", runtime / "game_runtime.py",
...
def _mapping(package_root: Path) -> list[tuple[Path, Path, int, str]]:
    ...
    return [
        ...
        (runtime / "runtime_reconciler.py", INSTALL_ROOT / "runtime" / "runtime_reconciler.py", 0o644, "agent/runtime/runtime_reconciler.py"),
