...
_ALLOWED_SUFFIXES=(".zip",".tar",".tar.gz",".tgz")
...
def quarantine_destination(transfer_id,filename):
 root=QUARANTINE_ROOT;candidate=(root/_token(transfer_id)/_filename(filename)).resolve();candidate.relative_to(root);return candidate
