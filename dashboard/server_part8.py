...
CONTROLLER_DASHBOARD_FILES={"/dashboard-v3.html":legacy.WEB_DIR/"dashboard-v3.html","/dashboard-home-v3.css":legacy.WEB_DIR/"dashboard-home-v3.css","/dashboard-home-v3.js":legacy.WEB_DIR/"dashboard-home-v3.js","/components/sidebar-v3.html":legacy.WEB_DIR/"components/sidebar-v3.html"}
CUSTOMER_PROTECTED_PAGES={"/customer.html","/customer-instance.html","/customer-members.html"};CONTROLLER_PROTECTED_PAGES={"/","/index.html","/console.html","/settings.html","/users.html","/agents.html","/contract-demo.html",*CONTROLLER_DASHBOARD_FILES.keys()}
legacy.STATIC_FILES.update(CUSTOMER_PUBLIC_FILES);legacy.STATIC_FILES.update(CUSTOMER_AUTHENTICATED_FILES);legacy.STATIC_FILES.update(CONTROLLER_DASHBOARD_FILES)
