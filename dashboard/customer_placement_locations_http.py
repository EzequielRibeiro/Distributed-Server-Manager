...
def dispatch_customer_placement_locations_get(path: str, *, user, backend, query=None):
    ...
    try:
        ...
        return 500, {
            "error": "placement_locations_unavailable",
            "message": "Não foi possível consultar as localizações disponíveis.",
        }
...
__all__ = [
    "CUSTOMER_PLACEMENT_LOCATIONS_PATH",
    "dispatch_customer_placement_locations_get",
    "install_customer_placement_locations",
]
