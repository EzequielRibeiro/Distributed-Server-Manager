...
def main()->int:
 ...
 sources={"install-agent.ps1":"agents/windows/installer/install-agent.ps1","agent/updater/updater.py":"agents/windows/updater/updater.py",**_tree_sources(ref,"agents/common","agent/common",(".py",)),**_runtime_sources(ref),**_tree_sources(ref,"agents/windows/service","service",(".ps1",)),**_tree_sources(ref,"agents/windows/gui","gui",(".ps1",))}
