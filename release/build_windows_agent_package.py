...
def main()->int:
 ...
 sources={"install-agent.ps1":"agents/windows/installer/install-agent.ps1","agent/common/identity.py":"agents/common/identity.py","agent/updater/updater.py":"agents/windows/updater/updater.py","service/register-task.ps1":"agents/windows/service/register-task.ps1",**_runtime_sources(ref)}
 ...
 manifest={"schema_version":1,"kind":"CapivaraAgentPackage","platform":"windows","version":version,"git_commit":commit,"channel":channel,"required_files":sorted(files),"files":{relative:{"sha256":hashlib.sha256(data).hexdigest(),"size":len(data)} for relative,data in sorted(files.items())}}
